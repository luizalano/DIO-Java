...
public class ExecutaParte1 {
    public static void main(String[] args) {
        ...
        Estado estadoParaAdicionar = new Estado("Toscana", "to");
        Aluno alunoParaAdicionar = new Aluno("Daniel", 29, estadoParaAdicionar,"M");
        ...
        alunoParaAdicionar = new Aluno("Alano", 55, estadoParaAdicionar,"M");
