...
public class Desafio0605 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Agora começa o jogo!!!!!");
        ...
        List<Map<String, Integer>> operacoes = lerOperacoes(qtdeOperacoes, it);
        Integer tabuleiro[][] = criarTabuleiro(tamanhoTabuleiro);

        for(Map<String, Integer> operacao : operacoes) {
            if(operacao.get("tipoOp") == 1) {
                tabuleiro = realizarOperacao1(operacao, tabuleiro, tamanhoTabuleiro);
            } else if(operacao.get("tipoOp") == 2) {
                tabuleiro = realizarOperacao2(operacao, tabuleiro, tamanhoTabuleiro);
            } else if(operacao.get("tipoOp") == 3) {
                Map<Integer, Integer> repeticoesNumero = lerRepeticoesLinhaX(operacao, tabuleiro, tamanhoTabuleiro);
                ...
                Map<Integer, Integer> repeticoesNumero = lerRepeticoesColunaX(operacao, tabuleiro, tamanhoTabuleiro);
                Integer maiorNumeroComMaiorRepeticao = avaliaMaiorNumeroComMaiorRepeticao(repeticoesNumero);
                System.out.println(maiorNumeroComMaiorRepeticao);
            }
        }
