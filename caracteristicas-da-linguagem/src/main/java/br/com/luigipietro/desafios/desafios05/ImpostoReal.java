...
public class ImpostoReal {
    ...
    class Vertex {
        ...
        public int calculateTotalDistance(Vertex previousCity) {
            ...
            for (var edge : edgesList) {
                ...
                travelsNumber = (int) Math.ceil(edge.destinationVertex.taxQuantity / ImpostoReal.cargoCapacity) * 2;
    ...
    public static void main(String[] args) {
        ...
        ImpostoReal.cargoCapacity = Integer.parseInt(lineArgs[1]);
        ...
        ImpostoReal impostoReal = new ImpostoReal();

        for (int i = 0; i < N; i++) {
            Vertex city = impostoReal.new Vertex(taxQuantities.get(i));
            cities.add(city);
        }
